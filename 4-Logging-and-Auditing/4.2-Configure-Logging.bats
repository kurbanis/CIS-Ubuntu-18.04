...
@test "4.2.1.3 Ensure logging is configured (Not Automated)" {
...
@test "4.2.1.6 Ensure remote rsyslog messages are only accepted on designated log hosts. (Not Automated)" {
    skip "This audit has to be done manually"
}
